class UserAdressesController < ApplicationController
  before_action :set_user_adress, only: [:show, :edit, :update, :destroy]

  # GET /user_adresses
  # GET /user_adresses.json
  def index
    @user_adresses = UserAdress.all
  end

  # GET /user_adresses/1
  # GET /user_adresses/1.json
  def show
  end
  ...
  # POST /user_adresses
  # POST /user_adresses.json
  def create
    @user_adress = UserAdress.new(user_adress_params)

    respond_to do |format|
      if @user_adress.save
        format.html { redirect_to @user_adress, notice: 'User adress was successfully created.' }
  ...
  # PATCH/PUT /user_adresses/1
  # PATCH/PUT /user_adresses/1.json
  def update
    respond_to do |format|
      if @user_adress.update(user_adress_params)
        format.html { redirect_to @user_adress, notice: 'User adress was successfully updated.' }
  ...
  # DELETE /user_adresses/1
  # DELETE /user_adresses/1.json
  def destroy
    @user_adress.destroy
    respond_to do |format|
